...
8. `src/AgentSmith.Cli/Program.cs` (top-level try/catch)
9. `src/AgentSmith.Server/Contracts/IJobSpawner.cs` (added IsAliveAsync)
10. `src/AgentSmith.Server/Services/DockerJobSpawner.cs` (IsAliveAsync implementation)
11. `src/AgentSmith.Server/Services/KubernetesJobSpawner.cs` (IsAliveAsync implementation)
12. `src/AgentSmith.Server/Services/OrphanJobDetector.cs` (liveness-based orphan detection)
