...
```bash
$ dotnet run --project src/backend/AgentSmith.Cli -- --dry-run "fix #1 in agent-smith"
...
```bash
$ dotnet run --project src/backend/AgentSmith.Cli -- --verbose "fix #1 in agent-smith"
```
...
```bash
$ echo "y" | dotnet run --project src/backend/AgentSmith.Cli -- --verbose "fix #1 in agent-smith"
```
