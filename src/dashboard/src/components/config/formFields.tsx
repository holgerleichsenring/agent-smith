...
// p0499: the string->string map editor lives in its own file — it is a row list with
// its own state, not a primitive input. Re-exported so the field vocabulary stays in
// one import for every form.
