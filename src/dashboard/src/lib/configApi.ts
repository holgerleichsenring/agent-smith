...
export interface TemplateReference {
  context: string;
  /** 2026-09-16-4df5: which repo of THIS project `context` belongs to — the picker stores
   *  it on every pick. Null means "wherever that name is", as stored before it did. */
