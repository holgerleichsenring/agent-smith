...
public sealed class CitedFileIndex
{
    ...
    /// <summary>
    /// The path-like tokens in a citation. A citation is written for a HUMAN, so it carries
    /// line numbers ("File.cs:44") and asides ("inventory.md (both repositories)") — p0422,
    /// run 17: an account was refused as an invention over the parenthesis after a real
    /// file. What must not pass is a citation naming NO file the evidence covers;
    /// punctuation around one is not that.
    /// </summary>
