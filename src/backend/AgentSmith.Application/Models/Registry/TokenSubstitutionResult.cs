...
/// file. On failure (an __AS_TOKEN_&lt;host&gt;__ placeholder whose host has no
/// configured registry) <see cref="Content"/> is null and the file MUST NOT be
/// written — a half-substituted or empty auth file silently breaks restore.
/// </summary>
