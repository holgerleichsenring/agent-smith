...
namespace AgentSmith.Infrastructure.Persistence.SqlServer.Migrations
{
    ...
    [Migration("20260917101329_AddSpecDialogSessionOwnerIndex")]
    partial class AddSpecDialogSessionOwnerIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgentSmith.Infrastructure.Persistence.Entities.RunCriterionJudgement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("RunId", "CriterionKey")
                        .IsUnique();

                    b.ToTable("RunCriterionJudgements");
                });
