...
internal static class ServerEndpointExtensions
{
    ...
    internal static WebApplication MapDashboardApi(this WebApplication app)
    {
        ...
        app.MapTicketConversationEndpoints(); // 8e51b: which conversation a ticket has
        ...
        app.MapAccessEndpoints(); // 2026-08-26-7a51: who may do what — people, groups, roles, claims
        app.MapDataArchiveEndpoints(); // 2026-08-28-3793: the whole database, out and back in
