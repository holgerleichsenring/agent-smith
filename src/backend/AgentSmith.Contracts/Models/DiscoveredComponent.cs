...
/// <param name="Workdir">Repo-relative COMPONENT ROOT — the directory holding the manifest that governs this component (e.g. "server", "src/Sample.Cli"); where there is none, the directory its evidence sits in; "." only where that directory is the repo root.</param>
