...
/// <summary>
/// p0429: the labels themselves, split from the lookup — the same shape
/// <see cref="CommandModelUse"/> has carried since it was written. A table that grows
/// with every command is not a reason for the lookup beside it to grow too.
/// </summary>
