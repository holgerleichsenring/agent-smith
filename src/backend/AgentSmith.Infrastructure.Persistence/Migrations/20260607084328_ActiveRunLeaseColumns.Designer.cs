...
namespace AgentSmith.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260607084328_ActiveRunLeaseColumns")]
    partial class ActiveRunLeaseColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgentSmith.Infrastructure.Persistence.Entities.TicketLifecycle", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("Project", "Platform", "TicketId")
                        .IsUnique();

                    b.ToTable("TicketLifecycles");
                });

            modelBuilder.Entity("AgentSmith.Infrastructure.Persistence.Entities.ActiveRun", b =>
                {
                    b.HasOne("AgentSmith.Infrastructure.Persistence.Entities.Run", "Run")
                        .WithMany()
                        .HasForeignKey("RunId");
