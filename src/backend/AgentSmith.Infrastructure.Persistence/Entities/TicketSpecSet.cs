...
/// <summary>
/// p0393a: one row per (Project, spec-set key) — the pointer at a spec that lives
...
/// </summary>
public sealed class TicketSpecSet : EntityBase
{
    public long Id { get; set; }
    public string Project { get; set; } = string.Empty;

    /// <summary>The spec-set key: &lt;provider&gt;-&lt;ticketId&gt;.</summary>
