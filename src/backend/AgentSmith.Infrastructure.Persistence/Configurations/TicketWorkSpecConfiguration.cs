...
/// <summary>
/// p0390: UNIQUE(Project, SpecKey) makes "one pointer per ticket" a database
...
/// </summary>
public sealed class TicketWorkSpecConfiguration : IEntityTypeConfiguration<TicketWorkSpec>
{
    public void Configure(EntityTypeBuilder<TicketWorkSpec> builder)
    {
