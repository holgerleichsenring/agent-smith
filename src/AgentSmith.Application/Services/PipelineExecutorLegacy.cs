...
/// <summary>
/// Legacy monolithic pipeline executor (pre-p0147e). Kept alongside the new
/// composed shape behind a feature flag so the test pack can assert identical
/// outcomes across both. Slated for removal after one release cycle.
///
...
/// </summary>
public sealed class PipelineExecutorLegacy(
