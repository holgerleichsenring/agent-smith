...
internal static class FeatureCommand
{
    public static Command Create(Option<string> configOption, Option<bool> verboseOption)
    {
        ...
        var cmd = new Command("feature", "Add a feature (plan, execute, tests, docs, PR)")
        {
        ...
        cmd.SetHandler(async (InvocationContext ctx) =>
        {
            ...
            var request = new PipelineRequest(
                project, "add-feature", new TicketId(ticket.ToString()), Headless: headless);
