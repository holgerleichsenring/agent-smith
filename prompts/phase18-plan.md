...
|--------|---------|-----------|-------------|----------|
| `FixTicketIntent` | "fix #65 in acme-pay" | K8s Job | Yes | Minutes |
| `ListTicketsIntent` | "list tickets in acme-pay" | Direct (Dispatcher) | No | <5s |
| `CreateTicketIntent` | "create ticket 'Add logging' in acme-pay" | Direct (Dispatcher) | No | <5s |
...
AgentSmith.Dispatcher/
  ...
  Services/
    ChatIntentParser.cs         # "fix #65 in acme-pay" → FixTicketIntent
