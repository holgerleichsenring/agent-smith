...
public sealed class RoutePermissionGuardTests
{
    ...
    [Fact]
    public void RouteGuard_TheTwelveAnonymousRoutes_AreExactlyTheDeclaredSet()
    {
    ...
    public void RouteGuard_DashboardApiDisabled_EnumeratesOnlyTheUnconditionalRoutes()
    {
        ...
        gated.Should().HaveCount(11, "everything left with the dashboard off is a machine caller or a probe");
    }
