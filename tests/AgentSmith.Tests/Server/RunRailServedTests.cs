...
public sealed class RunRailServedTests : IDisposable
{
    ...
    private RunStepsReader Steps() => new(_scopes, new RunStepAggregatesReader());
    ...
    {
        _projector ??= new RunDbProjector(_scopes, new RunEventApplier(new(), new(), new(), new(), new()), _clock);
