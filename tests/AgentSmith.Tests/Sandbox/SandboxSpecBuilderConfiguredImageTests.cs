...
public sealed class SandboxSpecBuilderConfiguredImageTests
{
    ...
    {
        var spec = NewSut().Build(ProjectWithImages(("csharp", "my-mirror/dotnet:9.0")), language: "csharp", pipelineName: "code");
    ...
    public void ConfiguredImage_BeatsContextImage()
    {
        ...
        var spec = NewSut().Build(
            ProjectWithImages(("node", "my-mirror/node:20")), language: "node", pipelineName: "code",
    ...
    public void ToolchainImageOverride_BeatsConfiguredImage()
    {
        ...
        var spec = NewSut().Build(project, language: "csharp", pipelineName: "code");
    ...
    {
        var spec = NewSut().Build(ProjectWithImages(("DOTNET", "my-mirror/dotnet:9.0")), language: "dotnet", pipelineName: "code");
    ...
    public void UnmatchedLanguage_FallsThroughToCodeTable()
    {
        ...
        var spec = NewSut().Build(ProjectWithImages(("dotnet", "my-mirror/dotnet:9.0")), language: "node", pipelineName: "code");
