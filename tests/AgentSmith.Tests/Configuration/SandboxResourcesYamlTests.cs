...
public sealed class SandboxResourcesYamlTests : IDisposable
{
    ...
    public void LoadConfig_SandboxResourcesPresent_PopulatesResourceLimitsRecord()
    {
        File.WriteAllText(_tempFile, """
            ...
            secrets: {}
            """);
        var loader = new YamlConfigurationLoader(new RawConfigMaterializer(new ProjectConfigNormalizer(new ClarificationParkStatusValidator()), new EffectiveTriggerBuilder(), new DeploymentDefaultsApplier(), new ConfigCatalogResolver(), new AgentSmithPaths()), new NoOpSystemEventPublisher());
