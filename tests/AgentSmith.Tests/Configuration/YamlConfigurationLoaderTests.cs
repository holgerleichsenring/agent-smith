...
public class YamlConfigurationLoaderTests
{
    private readonly YamlConfigurationLoader _loader =
        new(new RawConfigMaterializer(new ProjectConfigNormalizer(new ClarificationParkStatusValidator()), new EffectiveTriggerBuilder(), new DeploymentDefaultsApplier(), new ConfigCatalogResolver(), new AgentSmithPaths()), new NoOpSystemEventPublisher());
