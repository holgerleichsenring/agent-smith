...
public class YamlConfigurationLoaderTests
{
    private readonly YamlConfigurationLoader _loader =
        new(new RawConfigMaterializer(new ProjectConfigNormalizer(), new EffectiveTriggerBuilder(), new DeploymentDefaultsApplier(), new ConfigCatalogResolver(), new AgentSmithPaths()), new NoOpSystemEventPublisher());
