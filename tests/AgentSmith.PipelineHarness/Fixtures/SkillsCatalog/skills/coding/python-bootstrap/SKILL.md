...
description: "Harness fixture bootstrap producer for the python project language. Minimal shape — exercises BootstrapDispatch + BootstrapRound, not real bootstrap output."
role: "producer"
