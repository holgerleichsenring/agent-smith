...
* a confirmation offers the other shapes the proposal could take (2026-09-22-355b) ([515e46f](https://github.com/holgerleichsenring/agent-smith/commit/515e46fdcd91fe7cff6e7239a60867b26bb92bd7))
* a conversation delete confirms in the page (2026-09-20-4b0ab) ([98d979b](https://github.com/holgerleichsenring/agent-smith/commit/98d979b13893a8c83535ce769b524d6a955477ce))
* a conversation is headed by what it is about (2026-09-20-4b0af) ([5fae18f](https://github.com/holgerleichsenring/agent-smith/commit/5fae18f36db4d7c09e26ef0e876fd4abddeb37f2))
* a conversation's row says what it is about (2026-09-21-f237a) ([31ed12d](https://github.com/holgerleichsenring/agent-smith/commit/31ed12d9ee90bb341bf9dc7ac553d924657b84f9))
...
* a design conversation takes a screenshot (2026-09-20-3af8) ([31d1bd1](https://github.com/holgerleichsenring/agent-smith/commit/31d1bd101b47bf5eb0f25caa04e83a61399ab8ef))
* a design turn discusses before it proposes (2026-09-17-042ec) ([b3a1f90](https://github.com/holgerleichsenring/agent-smith/commit/b3a1f90be0a9e9efdbc677c7ba9a98c7ed05919c))
* a design turn fans out into bounded read-only children (2026-09-22-5891) ([883417e](https://github.com/holgerleichsenring/agent-smith/commit/883417e6a769e3ca80fc578117712fae122b5d75))
* a design turn reviews what it proposes (2026-09-17-042ed) ([f26fabb](https://github.com/holgerleichsenring/agent-smith/commit/f26fabb60f12c788b6f1aa704d4683627dfd386b))
* a design turn says what it is doing (2026-09-17-042ee) ([594a760](https://github.com/holgerleichsenring/agent-smith/commit/594a760d3609c9d1ed0727b4609dccf07ad5ef2c))
* a design turn says which repositories it opens (2026-09-17-c7aec) ([7b9f4a8](https://github.com/holgerleichsenring/agent-smith/commit/7b9f4a823b5be66b54fdd366c544292ef213669e))
...
* a filed epic child is linked to its parent in the tracker (2026-09-17-042ea) ([0b08f68](https://github.com/holgerleichsenring/agent-smith/commit/0b08f689194705b5fb13509d0e500329be2eb48f))
* a filed ticket carries its routing tag before it resolves (2026-09-20-2ba8) ([ef8ebfb](https://github.com/holgerleichsenring/agent-smith/commit/ef8ebfbbb891560bca136001c1145d04462f867b))
* a filed ticket says what its labels bind, and no prompt carries it (2026-09-18-d518) ([0d33b0b](https://github.com/holgerleichsenring/agent-smith/commit/0d33b0b96c1549c1d5372bf6ea35a5b4ea03a306))
* a filing can be withdrawn when nothing has claimed it (2026-09-22-9519) ([29bfc22](https://github.com/holgerleichsenring/agent-smith/commit/29bfc222796a3caff14451c6b4ab1ace49b31c72))
* a page arriving during a computing turn sees what it is doing (2026-09-18-2f8b) ([f7399d1](https://github.com/holgerleichsenring/agent-smith/commit/f7399d1ed565e03362adadb0bd971044291b9cb7))
* a parked run whose relaunch is under way shows its place (2026-09-22-7c41c) ([823029f](https://github.com/holgerleichsenring/agent-smith/commit/823029fdc79fedb8dea262dfc3724cf76ce3bd14))
...
* a phase's own diff is reviewed against its spec before the run moves on (2026-09-17-042eh) ([c8f55a3](https://github.com/holgerleichsenring/agent-smith/commit/c8f55a38d0144f07747279bac6648c3e0ddf5e75))
* a phase's premises are checked against the code before its work starts (2026-09-17-0e79c) ([206cbf2](https://github.com/holgerleichsenring/agent-smith/commit/206cbf27ccbdbdbca616817374c630fc6aebe590))
* a premise check settles a gate by running it (2026-09-20-9c74) ([93f4039](https://github.com/holgerleichsenring/agent-smith/commit/93f403903ff24b6d33e578255e98af9d81c17275))
* a project card expands into a wiring graph (2026-09-16-942a) ([428c0e1](https://github.com/holgerleichsenring/agent-smith/commit/428c0e1c83a2a85e06f07e9e7f813bcce4c07790))
...
* a read-only source scope clones one branch at one commit (2026-09-22-b41d) ([bdad0cc](https://github.com/holgerleichsenring/agent-smith/commit/bdad0cc751c5fd657cc9834bb53f533f4c93e489))
...
* a reply the page can reach speaks its language (2026-09-17-042ek) ([a8a5895](https://github.com/holgerleichsenring/agent-smith/commit/a8a589503e54d64d3ca0cba8309c1505e15ed79a))
* a reserved phrase asks for an approved spec to be cut again (2026-09-22-8b25) ([8d8275d](https://github.com/holgerleichsenring/agent-smith/commit/8d8275d641cedddb3d489475179e93399ca55616))
...
* a run takes its specification from the ticket branch (2026-09-22-6ad7) ([c1b5d87](https://github.com/holgerleichsenring/agent-smith/commit/c1b5d87583159f31dd2c5c5c7478e5089d24d0b0))
...
* a source scope refuses a shell, not a process (2026-09-22-46ef) ([e312c1e](https://github.com/holgerleichsenring/agent-smith/commit/e312c1eaa3d8c510e0f3739b73894473aaee3580))
...
* a template binding may name its local repo (2026-09-16-4df5) ([5013fd7](https://github.com/holgerleichsenring/agent-smith/commit/5013fd79503f5df52a0caa13dae8455a118f3659))
* a template binding may name its local repo (4df5) ([75873d8](https://github.com/holgerleichsenring/agent-smith/commit/75873d8897e0b84c65adc4a0c6396b810fd9ec62))
...
* a ticket whose status could not be moved is claimed once, not once per poll cycle (2026-09-18-c1a7) ([d3476f2](https://github.com/holgerleichsenring/agent-smith/commit/d3476f2ae279b9a1f5b0bec28e8f2cc49d8a8551))
* a turn that has filed work is told it cannot change it (2026-09-22-deda) ([0822aa7](https://github.com/holgerleichsenring/agent-smith/commit/0822aa73591e280a1a7a76790ba9af6cabb45642))
* an approval answer is recorded as a decision (2026-09-17-042el) ([139c070](https://github.com/holgerleichsenring/agent-smith/commit/139c070cc6700320475573e08fadc7d8da46fb2c))
* an approved cut files one ticket (2026-09-22-b3d7) ([b599796](https://github.com/holgerleichsenring/agent-smith/commit/b599796d5093be83ff38a252462f9512966ada41))
* an approved epic is one work ticket, one run, one pull request per repository (2026-09-17-0e79d) ([2796a08](https://github.com/holgerleichsenring/agent-smith/commit/2796a08ed8e82e4c63c2665d0b7a5a8f9d0cf85c))
* an approved set reaches its ticket branch at filing (2026-09-22-b6ad) ([3ad7012](https://github.com/holgerleichsenring/agent-smith/commit/3ad7012059e92d11bb0a15f0595ac795d9ca4aa8))
* an approved spec set is never re-cut behind the operator (2026-09-17-0e79b) ([4eceb18](https://github.com/holgerleichsenring/agent-smith/commit/4eceb1847a70d40c4e3cb5eec0089865db57e5d0))
* an approved spec set is the source a run executes (2026-09-17-0e79a) ([f99a891](https://github.com/holgerleichsenring/agent-smith/commit/f99a891ab78ccb6246b8850a35ebccdf2151ce23))
* an epic child ticket says when it is done (2026-09-17-042eb) ([24b18cb](https://github.com/holgerleichsenring/agent-smith/commit/24b18cb67e383cb914d26f7d37328744b4fdb4b7))
...
* an operator chooses the work-item kind each filed role creates (2026-09-18-b4f0) ([d0cb197](https://github.com/holgerleichsenring/agent-smith/commit/d0cb197294336a50dffd893c479bda6472c724c4))
* an operator deletes a conversation they own (2026-09-18-7a05) ([803f0ea](https://github.com/holgerleichsenring/agent-smith/commit/803f0ea97cef61ed3e7fecab328088e75b400b00))
* approving in the dialog makes the filed work start, and says so (2026-09-17-042eg) ([6e0cb95](https://github.com/holgerleichsenring/agent-smith/commit/6e0cb9503f963a8bafc667f36378828a53d28612))
...
* every conversation gets a page and an address (2026-09-21-f237b) ([7e40c13](https://github.com/holgerleichsenring/agent-smith/commit/7e40c1353f8d29519604a16659050dce1c54067c))
...
* routing binds to the approval, not to a word (2026-09-22-766b) ([d5e8c9f](https://github.com/holgerleichsenring/agent-smith/commit/d5e8c9ff999c421c28a1c805d8298a1ed33744d1))
...
* text Work it out did not choose wraps instead of being clipped (2026-09-18-e63d) ([3ec65d7](https://github.com/holgerleichsenring/agent-smith/commit/3ec65d79820fc7e6f0fb9912dc132e8576d7d551))
* the anonymous installation report names the catalog (2026-09-20-4981) ([b301eb7](https://github.com/holgerleichsenring/agent-smith/commit/b301eb7b21f97dda1754f551bcaeafb796765c8f))
* the card row is the disclosure and Edit is the way in (2026-09-16-d7c3) ([2e4dd3b](https://github.com/holgerleichsenring/agent-smith/commit/2e4dd3b4e5797130e6375b39b4b354b8751531b3))
* the catalog page names the origin of the skills it shows (2026-09-18-84be) ([7b240d0](https://github.com/holgerleichsenring/agent-smith/commit/7b240d00e7cbc3656ed11c3440c35c640682c1e2))
...
* the composer attaches with a plus and sends with an arrow (2026-09-20-4b0ac) ([648e825](https://github.com/holgerleichsenring/agent-smith/commit/648e82584eda72e0a32054de6b41b044004ddb1c))
* the concurrent-sandbox bound is set in the catalog (2026-09-18-0f27) ([e374e37](https://github.com/holgerleichsenring/agent-smith/commit/e374e3724f34a4eeb0599e35ef4371c47b2720c2))
* the conversation list follows the replies and filed tickets read as keys (2026-09-17-042em) ([5e84711](https://github.com/holgerleichsenring/agent-smith/commit/5e847112b6507d54d10060270c7031f69048aa1f))
* the conversation that filed work follows its run, phase by phase (2026-09-17-042ej) ([1393d21](https://github.com/holgerleichsenring/agent-smith/commit/1393d21bf0178b87c21c130f089df2b5dc8701b6))
* the conversations panel is one Recents list (2026-09-21-f237c) ([2c4d50c](https://github.com/holgerleichsenring/agent-smith/commit/2c4d50ce77d72c68df3fa57b56affdff2b09501c))
...
* the cut review answers without a ticket (2026-09-15-a5a5) ([eeac201](https://github.com/holgerleichsenring/agent-smith/commit/eeac201c452cafacadf5124ad11c0cf3a1b247af))
* the cut review rests on the code (2026-09-15-ffa7) ([49bbec9](https://github.com/holgerleichsenring/agent-smith/commit/49bbec98fceda53f0833183b3a485deaae6091d8))
* the dashboard shows a draft as structure (2026-09-17-c7aea) ([58f411d](https://github.com/holgerleichsenring/agent-smith/commit/58f411d9c671b48650395c5f73208961fd098723))
* the design conversation is grounded in the project's own rules (2026-09-19-4c1f) ([ee3ed3b](https://github.com/holgerleichsenring/agent-smith/commit/ee3ed3b85b94f09c41579d943181bc7424739c08))
* the design conversation reads the project's own rules, and five more ([1fa5d0c](https://github.com/holgerleichsenring/agent-smith/commit/1fa5d0c722f8cca500f841b0030dc7eb2a97935e))
* the design dialog collaborates, and the filing says only what it can keep ([aa7d6d2](https://github.com/holgerleichsenring/agent-smith/commit/aa7d6d29f21ad1e26f98ceedcd6152278777d3b2))
* the design surface becomes Work it out (2026-09-17-c7aed) ([1f92aa2](https://github.com/holgerleichsenring/agent-smith/commit/1f92aa2a986cadb51801d7e1f6f8c5406fbed6f3))
* the dialog shows what it would file (2026-09-15-6d9c) ([03c75cf](https://github.com/holgerleichsenring/agent-smith/commit/03c75cfd2c109b1b43131568dc857674f31b1f16))
* the gate runs the generated-mirror check it was missing (2026-09-18-7b31) ([83461b9](https://github.com/holgerleichsenring/agent-smith/commit/83461b9f63a96b37d771be4a3926361919b53451))
...
* the page stops typing commands at its own server (2026-09-22-2a86) ([f150feb](https://github.com/holgerleichsenring/agent-smith/commit/f150febef9146fe9d7ef87d71b040adb1903cf8b))
...
* the project card, built from its reference file (d7c3 + 4b41 + 5451) ([3f1853c](https://github.com/holgerleichsenring/agent-smith/commit/3f1853c1e84000afd4fee6a600e7e7a6d01f0ec4))
* the project drawer becomes five sections (2026-09-16-74a2) ([ad53e2f](https://github.com/holgerleichsenring/agent-smith/commit/ad53e2f484c8f0aad379a81c0c3369d0078c5aa4))
* the run's step budget follows the work it was given (2026-09-17-0e79e) ([d4ca9db](https://github.com/holgerleichsenring/agent-smith/commit/d4ca9db76b9c5444865565d6b6f5ce13c6e9c25c))
...
* the spec dialog gains a dashboard channel (2026-09-15-9033) ([0c3b1d2](https://github.com/holgerleichsenring/agent-smith/commit/0c3b1d260cd193d5a897e9e5864928d5f3638f47))
* the spec dialog gets its dashboard surface (2026-09-15-cb3e) ([3d09148](https://github.com/holgerleichsenring/agent-smith/commit/3d091482ce8e2b75d215f53f6c12ff880ba29cfe))
* the spec dialog reaches the dashboard ([25055c6](https://github.com/holgerleichsenring/agent-smith/commit/25055c64766a2143da45472367f8a1b058bf3d59))
...
* the spec is the truth, and Work it out follows the work it files ([aa83e2c](https://github.com/holgerleichsenring/agent-smith/commit/aa83e2ce602589b30b5fa96a602f9d9126a06354))
* the specification lives on the ticket branch, and one phrase can change it ([07a28d7](https://github.com/holgerleichsenring/agent-smith/commit/07a28d71a2d0f6ffe65ed4861165930fdbfd6dc8))
...
* the studio lists sort and a context says where it came from (2026-09-15-9b3e) ([5bba424](https://github.com/holgerleichsenring/agent-smith/commit/5bba424a1927be945c402cfdb3ce7739585df2a6))
* the studio lists sort and a context says where it came from (9b3e) ([d51d7fc](https://github.com/holgerleichsenring/agent-smith/commit/d51d7fceff5ba41eed5e90c5b0ef584bfc32b19d))
* the studio's project surface, reworked (a4d7 + 74a2 + 942a) ([c22fe61](https://github.com/holgerleichsenring/agent-smith/commit/c22fe61c24ac022462cd30e3ec1bfdb9df3cb75d))
* the tracker declares its fallback (2026-09-16-a4d7) ([bef1f78](https://github.com/holgerleichsenring/agent-smith/commit/bef1f78174796223c74770233302cbedf7c865ec))
* Work it out — the design dialog as a conversation with its result beside it ([37ae6db](https://github.com/holgerleichsenring/agent-smith/commit/37ae6db52f797715cb7a6167b16261388f23fd04))
* Work it out is drawn in the Projects page's own cards, marks, labels and buttons (2026-09-17-042ef) ([8371288](https://github.com/holgerleichsenring/agent-smith/commit/837128826ea8f7a72cc5ce3e5cd109ef1ea90fbc))
* your past conversations stay in the list (2026-09-17-c7aeb) ([ff81f1e](https://github.com/holgerleichsenring/agent-smith/commit/ff81f1eac92f52e11478cedbde112829ba4f6382))


### Bug Fixes

* a background dispatch disposes its scope asynchronously (2026-09-22-476a) ([5ca416a](https://github.com/holgerleichsenring/agent-smith/commit/5ca416af376ef86efdd139fad5c8ee775ce9912a))
* a background dispatch disposes its scope asynchronously (2026-09-22-476a) ([16ca1e6](https://github.com/holgerleichsenring/agent-smith/commit/16ca1e6838724c656e2a9de4ba19cccdc34d05ff))
* a cold start reconciles an unfinished run's unread terminal tail (2026-09-21-de50) ([bff16e9](https://github.com/holgerleichsenring/agent-smith/commit/bff16e9b621f91e86660771e37f36054773ae451))
* a decision is written through the run's sandbox, and a decision that cannot be written is a warning (2026-09-19-c511a, 2026-09-19-c511b) ([37162ed](https://github.com/holgerleichsenring/agent-smith/commit/37162ed6214c714676cd30d0f450c21dace7071b))
* a decision is written through the run's sandbox, and a failed write is a warning (2026-09-19-c511a, 2026-09-19-c511b) ([a2c5d91](https://github.com/holgerleichsenring/agent-smith/commit/a2c5d91b19c220c10ca291c980a8663d585c430a))
* a dropped queue entry finishes its run where the row lives (2026-09-21-c724c) ([fb91a87](https://github.com/holgerleichsenring/agent-smith/commit/fb91a87b4f9510293c3a1790489927fb8a30a597))
* a filed run leads with its status, not its timestamp (2026-09-20-c206) ([54cb530](https://github.com/holgerleichsenring/agent-smith/commit/54cb5302ae5791497988a0611c51a6534637d949))
* a filed ticket stops naming the conversation as where its spec is changed (2026-09-22-4d17) ([68602ed](https://github.com/holgerleichsenring/agent-smith/commit/68602ed65ffc8f9e30a6fe7a6fada89cd361a847))
* a first message opens its conversation in one act (2026-09-20-4b0aa) ([d99fbc9](https://github.com/holgerleichsenring/agent-smith/commit/d99fbc92e2a3ebecbbb2ff7c2bbfeadd61f03c7d))
* a hand-typed phase word still binds (2026-09-22-766b) ([95df429](https://github.com/holgerleichsenring/agent-smith/commit/95df429a85d51e7b15885affe96d2953ab1dd3fd))
* a park the tracker refused holds its ticket (2026-09-22-7c41b) ([d73dcc6](https://github.com/holgerleichsenring/agent-smith/commit/d73dcc685cb26bd3a7d1e585f2387e7a1f174206))
* a parked run resumes on the cap it was sized to (2026-09-22-7c41a) ([20c523e](https://github.com/holgerleichsenring/agent-smith/commit/20c523e2ddbac647facf1d496b8b91613015b3a9))
...
* a project card drops its type badge (2026-09-16-b706) ([29c9662](https://github.com/holgerleichsenring/agent-smith/commit/29c9662603e7c7a338732dbb409d6cd5ee986fd5))
* a project card drops its type badge (2026-09-16-b706) ([fe0c0e0](https://github.com/holgerleichsenring/agent-smith/commit/fe0c0e0f9f1a18d04c20b6de45204687efe5e12e))
* a project card's surface stops offering a pointer it ignores (2026-09-16-5451) ([3a8d860](https://github.com/holgerleichsenring/agent-smith/commit/3a8d860be6d9a864c69e8e1d25e1fce4f1464d5a))
* a queued run announces itself and a delete disarms its ticket (2026-09-20-9f00) ([1cac200](https://github.com/holgerleichsenring/agent-smith/commit/1cac200f01a189a6b95c36d1f2be2802f369d34c))
* a schema refusal names the cause (2026-09-20-2789) ([2326199](https://github.com/holgerleichsenring/agent-smith/commit/23261995d4aaa7a1f2c5bb661e271f6aad25a430))
* a template's proof reads the declaration it belongs to (2026-09-15-6f8d) ([4c1aa64](https://github.com/holgerleichsenring/agent-smith/commit/4c1aa64225fd56880b44d30f3f8f5aadc315956e))
* a ticket the claim would refuse is refused, not queued (2026-09-21-77d6) ([80b0683](https://github.com/holgerleichsenring/agent-smith/commit/80b068316f4825b78f6fd581b4991110085604e8))
* a waiting run names the gate that refused it (2026-09-21-5c17) ([78a9a96](https://github.com/holgerleichsenring/agent-smith/commit/78a9a964ad4a3bc593697ebccbc6385f5e883e3d))
* an enforcing installation nobody is signed into stops misreporting itself (2026-09-21-291b) ([bcd6590](https://github.com/holgerleichsenring/agent-smith/commit/bcd6590946ca27b8f678f8829fc382ebea19396f))
* an enforcing installation nobody is signed into stops misreporting itself (2026-09-21-291b) ([065efe2](https://github.com/holgerleichsenring/agent-smith/commit/065efe2f4087ad03cba22f5ce2ca222057f8be35))
* an operator retry moves the ticket before it drops the hold (2026-09-21-1fa0) ([6a0abd1](https://github.com/holgerleichsenring/agent-smith/commit/6a0abd1841808a846b94c5bfcb8fa5b51981c34b))
...
* inspecting a proposal acknowledges the click (2026-09-20-4b0ae) ([a6f4c60](https://github.com/holgerleichsenring/agent-smith/commit/a6f4c600a56d7f595d050380e935c650ad751bc3))
* the C# delta ships no build-breaking artefacts (2026-09-20-b5af) ([ab46fa9](https://github.com/holgerleichsenring/agent-smith/commit/ab46fa9e5580040fc3a783609df49d3bc8c12e9a))
* the card carries one wiring, not two (2026-09-16-bedc) ([cb774a4](https://github.com/holgerleichsenring/agent-smith/commit/cb774a40d87b4dba545d3ce08236eb2898ae3100))
* the card carries one wiring, not two (2026-09-16-bedc) ([b772d0c](https://github.com/holgerleichsenring/agent-smith/commit/b772d0c2722a0d95342e9001ef0acfab35ee80a3))
* the card controls hold their width (2026-09-16-8502) ([0b02f5e](https://github.com/holgerleichsenring/agent-smith/commit/0b02f5e138383a939359fd73c80145d3f187ebb2))
* the card controls hold their width (2026-09-16-8502) ([ed6857c](https://github.com/holgerleichsenring/agent-smith/commit/ed6857c3f28f1107b35d539265b130d160d55fc3))
* the claim loop, the turn that says it is computing, and the text that fits ([1a2b282](https://github.com/holgerleichsenring/agent-smith/commit/1a2b2824fbaa0706df9d90a6b5ee0508649ac154))
* the context picker always stores the repository ([b7a43b5](https://github.com/holgerleichsenring/agent-smith/commit/b7a43b57a0ef3baf7ab885bb5132ce67a3fa9f32))
* the context picker always stores the repository (2026-09-17-ce66) ([01f193c](https://github.com/holgerleichsenring/agent-smith/commit/01f193c6bbb479b4dc36b6018ae80b65f3ee7740))
* the dialog shows that it is working and asks the right question ([70c951d](https://github.com/holgerleichsenring/agent-smith/commit/70c951d448271633e41282511ace8f842777de99))
* the dialog shows that it is working and asks the right question (2026-09-15-cb3e, 2026-09-15-6d9c) ([8f46770](https://github.com/holgerleichsenring/agent-smith/commit/8f46770abdff4523f5a307fe49032d7db10a567b))
* the gate reads git's global options (2026-09-21-9ae2) ([2b898b5](https://github.com/holgerleichsenring/agent-smith/commit/2b898b56dbbbd45093f8d37c73497d406c4e66ee))
* the gate's skip flag is not inherited by the gates its tests drive (2026-09-22-6ff3) ([9824723](https://github.com/holgerleichsenring/agent-smith/commit/9824723b0241327ecea63d4faa55da7b1140a9b5))
* the merge of 4b0ac and 4b0ae left the joins file unclosed ([0e4d422](https://github.com/holgerleichsenring/agent-smith/commit/0e4d4224b558d99fb88df3f63991ccbdfea9a944))
* the merge of 4b0ae and 4b0af left two title declarations ([258a9d0](https://github.com/holgerleichsenring/agent-smith/commit/258a9d0fdad79b9d97e8784af84df112a4c3b6ae))
* the phase review event has its TypeScript mirror, and its payload says what it is (2026-09-17-042eh) ([2d8b78b](https://github.com/holgerleichsenring/agent-smith/commit/2d8b78be8c0a3efffa801e501b18e608b6ad52d9))
...
* the scope's vocabulary test follows the renamed refusal ([3005054](https://github.com/holgerleichsenring/agent-smith/commit/300505438abdca1828d8aeb677adabc0eaa336d5))
...
* **p0350:** stop a big run from crashing on its own throttle and losing its PRs ([e112214](https://github.com/holgerleichsenring/agent-smith/commit/e112214d93eb4f58443c6ef261b6c407091c6a6a))
* **p0350:** stop a big run from crashing on its own throttle and losing its PRs ([97fe8ea](https://github.com/holgerleichsenring/agent-smith/commit/97fe8ea88aa7bfe288af5abd47076529b2786ab7))
* re-resolve RunSnapshot vs merged p0348 LiveCompute + p0347 (p0350) ([4d9f4fb](https://github.com/holgerleichsenring/agent-smith/commit/4d9f4fbf241415fdd4347f067c4bc0deaadf8eee))
* resolve p0347 PR-surfacing overlap toward p0350's crash-resilient path (p0350) ([c7a4c13](https://github.com/holgerleichsenring/agent-smith/commit/c7a4c1335542342968de2138603a3c7f48a4361a))
